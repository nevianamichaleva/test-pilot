        ...
        <PageHero
          ...
          actions={
            <>
              ...
              <Link href="/igri" className={styles.heroActionGhost}>
                Хайде да поиграем <span aria-hidden>›</span>
              </Link>
            </>
          }
        />
        ...
        <section className={styles.card}>
          <div className={styles.hero}>
            <div className={styles.heroText}>
              ...
              <p className={styles.lead}>
                Майка съм на три деца, две от които са още ученици. Създадох
                тази платформа като личен образователен помощник за моите деца, за да упражняваме
                уроците по по-достъпен и практичен начин.
              </p>
              <p className={styles.lead}>
                Освен тестовете има и кратки образователни игри — за английски, български език,
                география, история и природа. Чрез игра децата затвърдяват правила, думи и факти с
                моментална обратна връзка и повече желание да продължат.
              </p>
            </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              Проектът събира тестове и упражнения по основни предмети засега за 5. и 7. клас —
              български език, математика, английски език, география, история, литература и човек и
              природа. Материалите са подредени по клас, предмет и тема, за да може детето бързо да
              намери точно това, което учи в момента.
            </p>
            <p className={styles.text}>
            ...
            <p className={styles.text}>
              В секцията „Хайде да поиграем“ има мини-игри за упражнение: конструктор на изречения и
              граматически детектив по английски, езикова работилница по БЕЛ, географски предизвикателства,
              кръстословици и преговор по история. Игрите са кратки, цветни и подходящи за
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              Ако забележиш грешка или имаш идея за подобрение, ще се радвам да ми пишеш
