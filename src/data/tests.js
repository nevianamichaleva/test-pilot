...
import {
  ...
  BULGARSKI_IUCH_5_KLAS_TEST_10_QUESTIONS,
  BULGARSKI_IUCH_5_KLAS_TEST_11_QUESTIONS,
  BULGARSKI_IUCH_5_KLAS_TEST_12_QUESTIONS,
...
const TESTS = {
  ...
  '5|bg|iuch-test-10': {
    title: 'Български език ИУЧ – Тест № 10 (5. клас)',
    slug: 'iuch-test-10',
    questions: BULGARSKI_IUCH_5_KLAS_TEST_10_QUESTIONS,
    preserveQuestionOrder: true,
  },
  '5|bg|iuch-test-11': {
    title: 'Български език ИУЧ – Тест № 11 (5. клас)',
    slug: 'iuch-test-11',
    questions: BULGARSKI_IUCH_5_KLAS_TEST_11_QUESTIONS,
    preserveQuestionOrder: true,
  },
  '5|bg|iuch-test-12': {
    title: 'Български език ИУЧ – Тест № 12 (5. клас)',
    slug: 'iuch-test-12',
    questions: BULGARSKI_IUCH_5_KLAS_TEST_12_QUESTIONS,
    preserveQuestionOrder: true,
  },
  '7|bg|bel-2024': {
    title: 'БЕЛ-2024',
  ...
  '6|istoriya|vhodno-nivo-grupa-1': {
    title: 'Входно ниво – Първа група (История 6. клас)',
    slug: 'vhodno-nivo-grupa-1',
    addedAt: '2026-08-21',
    questions: ISTORIA_VHODNO_6_GRUPA1_QUESTIONS,
    preserveQuestionOrder: true,
    preserveOptionOrder: true,
  },
  '6|istoriya|vhodno-nivo-grupa-2': {
    title: 'Входно ниво – Втора група (История 6. клас)',
